<template>
  <div>
    ...
    <el-dialog
      title="充值"
      :visible.sync="chargeDialog.dialogVisible"
      ...
      <el-form :model="chargeFormData" :rules="rules" ref="chargeForm" label-width="100px">
        <el-form-item label="金额(元)" prop="money">
          <el-input-number
            ...
            :precision="0"
            :step="10"
            @keyup.enter.native.prevent="charge()"
          ></el-input-number>
        </el-form-item>
      </el-form>
    ...
    <el-dialog
      title="使用积分"
      :visible.sync="useGoalDialog.dialogVisible"
      :close-on-click-modal="false"
      width="30%"
    >
      <el-form :model="useGoalFormData" ref="useGoalForm" label-width="100px">
        <el-form-item label="积分" prop="goal">
          <el-input-number
            v-model="useGoalFormData.goal"
            :precision="0"
            :step="10"
            @keyup.enter.native.prevent="useGoal()"
          ></el-input-number>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
    ...
    >
      <el-form :model="payFormData" :rules="payRules" ref="payForm" label-width="100px">
        <el-form-item label="猫咪售卖(元)" prop="money">
          <el-input-number
            v-model="payFormData.catSell"
            :precision="0"
            :step="10"
            @keyup.enter.native.prevent="pay()"
          ></el-input-number>
        </el-form-item>
        <el-form-item label="洗护服务(元)" prop="money">
          <el-input-number
            v-model="payFormData.washProtectService"
            :precision="0"
            :step="10"
            @keyup.enter.native.prevent="pay()"
          ></el-input-number>
        ...
        <el-form-item label="周边产品(元)" prop="money">
          <el-input-number
            v-model="payFormData.peripheralProducts"
            :precision="0"
            :step="10"
            @keyup.enter.native.prevent="pay()"
          ></el-input-number>
    ...
    <el-dialog
      title="修改分组"
      :visible.sync="selectLabelDialog.dialogVisible"
      :close-on-click-modal="false"
      width="30%"
    >
  ...
  export default {
    ...
    methods: {
      ...
      pay() {
        ...
        _that.payDialog.currentData.washProtectService =
