...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/api/admin/getUserInfo", "anon");
    ...
    public HashedCredentialsMatcher hashedCredentialsMatcher() {
        ...
        hashedCredentialsMatcher.setHashAlgorithmName(Md5Utils.HashAlgorithName);
        hashedCredentialsMatcher.setHashIterations(Md5Utils.HashIterations);
